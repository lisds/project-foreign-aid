...
csv_file_path_cor = 'data/Corruption.csv'  
xls_file_path_gdp = 'data/GDP.xls' 

# Load CSV files into a DataFrame
corruption_df = pd.read_csv(csv_file_path_cor)
GDP_pc_df = pd.read_excel(xls_file_path_gdp, skiprows=3)


dataset_names.extend(['corruption_df', 'GDP_pc_df'])
