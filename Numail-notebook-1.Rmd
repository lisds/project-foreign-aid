...
```{python}
# Focussing specifically on Africa..
...
WB_df.describe()
=======
Building on Saturday's work, these are my changes from 11th Dec onwards:
...
# Create a Sankey diagram with different colors for each donor
unique_donors = df_top_10['donor'].unique()
color_scale = ['blue', 'green', 'red', 'purple', 'orange', 'yellow', 'brown', 'pink', 'gray', 'cyan']  # Define your own list of colors
